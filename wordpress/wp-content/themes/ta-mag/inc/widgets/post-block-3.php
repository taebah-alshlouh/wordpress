...
add_action('widgets_init', 'ta_mag_highlight_posts_2_register');

function ta_mag_highlight_posts_2_register() {
    register_widget('Ta_Mag_Highlight_Posts_2_Widget');
}

class Ta_Mag_Highlight_Posts_2_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
                'Ta_Mag_Highlight_Posts_2_Widget', esc_html__('TA : Home Section Block 3', 'ta-mag'), array(
                'description' => esc_html__('TA : Home Section Block 3', 'ta-mag')
                )
        );
    }
        ...
        <div class="ta-highlight-wrap">
            ...
            <div class="ta-container clearfix">
                ...
                <div class="ta-row">
                    ...
                    <div class="ta-match-height ta-col-3 ta-highlight-wrap-3">
                        ...
                        <div class="ta-row">
                            ...
                            while( $highlight_post_query->have_posts() ){
                                ...
                                if( $i == 1 || $i == 2 ){
                                    ...
                                    <div class="ta-highlight-loop ta-col-12 ta-highlight-loop-1">
                    ...
                    <div class="ta-col-6 ta-highlight-wrap-4">
