...
add_action('widgets_init', 'ta_mag_grid_post_2_register');

function ta_mag_grid_post_2_register() {
    register_widget('Ta_Mag_Grid_Posts_2_Widget');
}

class Ta_Mag_Grid_Posts_2_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
                'Ta_Mag_Grid_Posts_2_Widget', esc_html__('TA : Home Section Grid 2', 'ta-mag'), array(
                        ...
                        <div class="grid-blog-main-wrap">
                            <div class="ta-row-2 clearfix">
                                ...
                                while( $grid_post_query->have_posts() ){
                                        ...
                                        $recent_post_image = wp_get_attachment_image_src( get_post_thumbnail_id(),'ta-mag-grid' );
                                        $recent_post_image = isset( $recent_post_image[0] ) ? $recent_post_image[0] : ''; ?>

                                        <div class="ta-match-height ta-col-2-4">
                                            
                                            <article class="ta-home-article">
                                                ...
                                                <div class="ta-content-wraper">
                                                    ...
                                                    <?php echo '<h2 class="entry-title ta-large-font ta-secondary-font"><a href="' . esc_url( get_permalink() ) . '" rel="bookmark">'.esc_html( wp_trim_words( get_the_title(),10,'...' ) ).'</a></h2>'; ?>
