...
function melos_thinkup_child_frontscripts() {
	...
	wp_enqueue_style( 'melos-thinkup-style-blog', get_stylesheet_directory_uri() . '/style.css', array( 'thinkup-style' ), wp_get_theme()->get('Version') );
}
...
function melos_thinkup_updateoption_child_settings() {
	...
	$name_child_color   = $name_theme_lower . '_thinkup_child_color_blog';
